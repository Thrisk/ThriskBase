...
public final class CustomOre extends Block {
	...
	protected CustomOre(String blockName,Material material,String pngFileName,Float hardnessF,Float resistanceF,Float lightLevel,String harvester, Integer hLevel, Item drop, int meta, int least, int most) {
		super(material);
