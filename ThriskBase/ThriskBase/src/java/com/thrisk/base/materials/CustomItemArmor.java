...
// Needs To Be Fixed Armor Cannot Be Equip
...
public class CustomItemArmor extends Item {
	    ...
	    private final CustomItemArmor.ArmorMaterials material;
	    @SideOnly(Side.CLIENT)
	    private IIcon overlayIcon;
	    @SideOnly(Side.CLIENT)
	    private IIcon emptySlotIcon;

	    public CustomItemArmor(CustomItemArmor.ArmorMaterials p_i45325_1_, int p_i45325_2_, int p_i45325_3_)
	    {
	    ...
	    {
	        return this.material == CustomItemArmor.ArmorMaterials.CLOTH;
	    }
	     ...
	     */
	    public CustomItemArmor.ArmorMaterials getArmorMaterial()
	    {
	    ...
	    {
	        return this.material != CustomItemArmor.ArmorMaterials.CLOTH ? false : (!p_82816_1_.hasTagCompound() ? false : (!p_82816_1_.getTagCompound().hasKey("display", 10) ? false : p_82816_1_.getTagCompound().getCompoundTag("display").hasKey("color", 3)));
	    }
	    ...
	    {
	        if (this.material != CustomItemArmor.ArmorMaterials.CLOTH)
	        {
	            return -1;
	        }
	        else
	    ...
	    public static IIcon func_94602_b(int p_94602_0_)
	    {
	        ...
	        {
	            case 0:
	                return CustomItems.diamond_helmet.emptySlotIcon;
	            case 1:
	                return CustomItems.diamond_chestplate.emptySlotIcon;
	            case 2:
	                return CustomItems.diamond_leggings.emptySlotIcon;
	            case 3:
	                return CustomItems.diamond_boots.emptySlotIcon;
	            default:
	                return null;
	        }
	    }
		...
		// Armor Materials - Broken
	        ...
	        public int getDurability(int p_78046_1_){
	            return CustomItemArmor.maxDamageArray[p_78046_1_] * this.maxDamageFactor;
	        }
