...
public class CustomItemTool extends Item{
    ...
    protected CustomItemTool(float p_i45333_1_, ToolMaterials p_i45333_2_, Set p_i45333_3_)
    {
        ...
        if (this instanceof CustomItemPickaxe)
        {
            toolClass = "pickaxe";
        }
        else if (this instanceof CustomItemAxe)
        {
            toolClass = "axe";
        }
        else if (this instanceof CustomItemSpade)
        {
            toolClass = "shovel";
        }
    }
    ...
    public ToolMaterials func_150913_i()
    {
